...
const SelfImprovment = () => {
  ...
  return (
    <>
      <div className={`self-improvment ${HeaderPagesStyle["jumbo"]}`}>
      ...
      <section ref={articoliRef} className="pt-5 text-center bg-articles mx-3">
        <h2 className="articoli">READ ABOUT SELF IMROVMENT</h2>

        <div className="d-flex flex-wrap  justify-content-center">
          {ArticoliSelfImprovment.map((articolo) => (
            <div key={articolo.id}>
              <div className="card m-3 text-center">
                ...
                <div className="card-body">
                  ...
                  <Link
                    to={`/self-improvment-article/${articolo.id}`}
                    className="btn-card"
                  >
                    Scopri di più
                  </Link>
